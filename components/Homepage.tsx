...
function Footer() {
  return (
    <footer className="border-t border-line bg-white px-6 py-12 sm:px-12 lg:px-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Inversion-of-control patterns for multi-agent collaboration
          </p>
        </div>

        <nav className="flex flex-wrap gap-6 text-sm font-medium text-muted">
          <Link href="/gallery" className="transition hover:text-accent">
            Patterns
          </Link>
          <Link href="/advisor" className="transition hover:text-accent">
            Chat with Agent
          </Link>
          <Link href="/gallery" className="transition hover:text-accent">
            Docs
      ...
      <p className="mx-auto mt-8 max-w-6xl text-center text-xs text-subtle sm:text-left">
        © {new Date().getFullYear()} Human Agent IoC Patterns. Research-grounded
        agent UX patterns.
      </p>
    </footer>
  );
